            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="panel panel-primary">
                        ...
                        {!! Form::model($storehouse, ['method' => 'PUT', 'route' => ['storehouse.update', $storehouse->id]]) !!}
                        
                        <div class="panel-heading text-center">{{ $storehouse->name }}</div>
                        <div class="panel-body">
                            ...
                            @include('partials.rows.label-select', [
                                ...
                                'selected' => $storehouse->pharmacy_id
                            ])
                        </div>
