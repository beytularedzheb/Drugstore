...
<div class="panel panel-default">
    <div class="panel-heading"><h3>@lang('messages.products_by_storehouse')</h3></div>
    <div class="panel-body">
        {!! Form::open(['method' => 'POST', 'action' => ['ReportController@postProductsByStorehouse']]) !!}

        <select class="form-control" name="storehouse_id" onchange="submit()">
            <option value=""></option>
            @foreach (App\Storehouse::all() as $storehouse)
