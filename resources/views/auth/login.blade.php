                        ...
                        <div class="form-group">
                            <div class="col-md-6 col-md-offset-4">
                                <button type="submit" class="btn btn-primary">
                                    <i class="glyphicon glyphicon-log-in"></i> @lang('messages.login')
                                </button>

                                <a class="btn btn-link" href="{{ url(LaravelLocalization::getCurrentLocale() . '/password/reset') }}">@lang('messages.forgot_password')</a>
                            </div>
                        </div>
                    </form>
                </div>
